...
class _TerminalScrollGestureHandlerState
  ...
  void _onScroll(double offset) {
    ...
    // Ctrl+wheel is a zoom gesture (handled by the host app), not a scroll;
    // sending arrows would make apps like vim jump while zooming. Keep the
    // line bookkeeping in sync so the next plain scroll is accurate.
